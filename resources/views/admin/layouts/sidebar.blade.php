      ...
      <nav class="navbar navbar-expand-lg main-navbar">
          ...
          <ul class="navbar-nav navbar-right">
              <li class="dropdown"><a href="#" data-toggle="dropdown"
                      ...
                      <div class="d-sm-none d-lg-inline-block">Hi, Fajar Syafero</div>
                  </a>
          ...
          <aside id="sidebar-wrapper">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" style="display: none;">
                          <li class="nav-item"><a class="nav-link" href="{{ route('admin.typer-title.index') }}">Typer
                                  Title</a></li>
                          <li class="nav-item"><a class="nav-link" href="{{ route('admin.hero.index') }}">Hero
                                  section</a></li>
                      </ul>
                  </li>

                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.service.index') }}"><i
                              class="far fa-square"></i> <span>Services</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.about.index') }}"><i
                              class="far fa-square"></i> <span>About</span></a></li>
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" style="display: none;">
                          ...
                          <li class="nav-item"><a class="nav-link"
                                  href="{{ route('admin.portfolio-item.index') }}">Portfolio Item</a></li>
                          <li class="nav-item"><a class="nav-link"
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" style="display: none;">
                          <li class="nav-item"><a class="nav-link" href="{{ route('admin.skill-item.index') }}">Skill
                                  Items</a></li>
                          <li class="nav-item"><a class="nav-link"
                                  href="{{ route('admin.skill-section-setting.index') }}">Section Setting</a></li>
                      </ul>
                  </li>
                  <li class="nav-item"><a class="nav-link" href="{{ route('admin.experience.index') }}"><i
                              class="far fa-square"></i> <span>Experience</span></a></li>
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" style="display: none;">
                          ...
                          <li class="nav-item"><a class="nav-link" href="{{ route('admin.blog.index') }}">Blog
                                  List</a></li>
                          <li class="nav-item"><a class="nav-link"
